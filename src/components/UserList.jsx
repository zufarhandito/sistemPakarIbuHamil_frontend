...
const UserList = () => {
    ...
    const filterName = (e) => {
        ...
        if(input === "" || input === null){
            ...
            setUsers(users.filter(name=>name.firstName.includes(input)).map(filtered=>filtered))
        }
    }
    ...
    <div className="container mx-auto mt-10">
        ...
        <label htmlFor="my-modal-3" className="shadow-xl btn btn-primary my-7">Tambah Data</label>
            ...
            <div className="input-group">
                <input type="text" placeholder="Search…" onChange={(e)=>filterName(e)} className="input input-bordered" />
